...
{
	case SERVER_NAME_SWWW:
		$config['base_url']    = "https://sixtperu.pe/desarrollo/traslado";
		break;
    case SERVER_NAME_CWWW:
        $config['base_url']    = "https://www.sixtperu.pe/desarrollo/traslado";
        break;
